...
self_nearest_ycbcr = ycbcr2ycbcr422(self_nearest_ycbcr);
matlab_nearest_ycbcr = ycbcr2ycbcr422(matlab_nearest_ycbcr);
...
MSE_matlab_ycbcr = immse(matlab_nearest_ycbcr, YCbCr_422);
MSE_self_ycbcr = immse(self_nearest_ycbcr, YCbCr_422);
fprintf("-----------------------------------------\n");
